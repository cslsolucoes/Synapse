...
| `delphi-fpc-error-handling-and-diagnostics` | Ao alinhar códigos de exceção da faixa 93XXX com Exceptions module |
| `delphi-fpc-architecture-and-design` | Ao revisar contrato de façade (Loggers.Interfaces) ou introduzir novo destino de log |
| `project-refactoring-compatibility-policy` | Antes de renomear classes, métodos de facade ou alterar assinatura de ILogger |
