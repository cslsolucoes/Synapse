...
| `delphi-fpc-language-core` | Ao implementar lógica de bindings, eventos VCL/FMX/LCL específicos do framework |
| `delphi-fpc-testing-and-quality` | Ao estruturar forms de teste para validação manual de módulos backend |
| `project-refactoring-compatibility-policy` | Antes de renomear units de form ou alterar interface de form que outros forms referenciam |
