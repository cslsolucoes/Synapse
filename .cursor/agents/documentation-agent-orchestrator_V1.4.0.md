...
- 1.1.3 (01/04/2026): Secção **Class-level docs from source** (`doc-agent-class-*`); tabela **Skills to use** com `documentation-class-analysis-generator` e `documentation-paste_analysis_unit_class_method`; âmbito explícito `Analise/` / `Documentation/Analise/`; nota sobre skill **`documentation-orchestrator`** (portal HTML).
