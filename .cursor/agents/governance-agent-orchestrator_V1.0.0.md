...
- **`governance-orchestrator_V1.0.0`** — `.cursor/skills/governance-orchestrator_V1.0.0/SKILL.md`
- **`quick_ref`** — `.cursor/skills/governance-orchestrator_V1.0.0/consultas_rapidas/quick_ref.md`
- **`sub_domains`** — `.cursor/skills/governance-orchestrator_V1.0.0/consultas_rapidas/sub_domains.md`
