...
- **`version-orchestrator_V1.0.0`** — `.cursor/skills/version-orchestrator_V1.0.0/SKILL.md`
- **`quick_ref`** — `.cursor/skills/version-orchestrator_V1.0.0/consultas_rapidas/quick_ref.md`
