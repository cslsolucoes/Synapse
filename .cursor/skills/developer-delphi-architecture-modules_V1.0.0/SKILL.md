...
- Não usar para DI com containers, Event Bus ou padrões arquiteturais de alto nível → use `developer-delphi-architecture-and-design`.
- Não usar para tuning de build ou flags de compilador → use `developer-delphi-build-cross-compiler`.
...
|-------|-----------------------|
| `developer-delphi-architecture-and-design` | Antes de definir contratos de interface entre módulos |
| `developer-delphi-programming-conditional-defines` | Antes de criar packages com defines condicionais |
| `developer-delphi-build-cross-compiler` | Antes de configurar compilação de packages BPL |
