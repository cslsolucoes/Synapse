...
- Blocos `asm..end` dentro de funcoes Pascal → `developer-delphi-assembly-delphi-inline`.
- Funcoes puras assembly (keyword `assembler`) → `developer-delphi-assembly-delphi-functions`.
...
| ------------------------------------------------ | --------------------------------------------------- |
| `developer-delphi-assembly-delphi-inline`        | Para blocos asm dentro de funcoes Pascal            |
| `developer-delphi-assembly-delphi-functions`     | Para funcoes `assembler;` puras                     |
