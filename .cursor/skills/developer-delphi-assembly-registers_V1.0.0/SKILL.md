...
# developer-delphi-assembly-registers_V1.0.0
...
- `developer-delphi-assembly-x86-fundamentals_V1.0.0` — arquitetura, modos, modelo de memória
- `developer-delphi-assembly-instructions_V1.0.0` — conjunto de instruções
- `developer-delphi-assembly-stack-call_V1.0.0` — stack frame e convenções de chamada
