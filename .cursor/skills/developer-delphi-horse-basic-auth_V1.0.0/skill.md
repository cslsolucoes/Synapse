---
name: developer-delphi-horse-basic-auth
...
- Autenticação JWT Bearer → `developer-delphi-horse-jwt`
- Geração/validação de tokens JWT → `developer-delphi-horse-security`
