...
- Servidor HTTP Horse → `developer-delphi-horse-core`
- Serialização JSON ↔ DataSet standalone → `developer-delphi-horse-serialization`
- JWT geração → `developer-delphi-horse-security`
