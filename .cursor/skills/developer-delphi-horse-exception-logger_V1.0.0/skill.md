---
name: developer-delphi-horse-exception-logger
...
- Log de acesso normal (requests/responses) → `developer-delphi-horse-logger`
- Intercepção de erros HTTP → `developer-delphi-horse-handle-exception`
