---
name: developer-delphi-horse-handle-exception
...
- Log de exceções em disco → `developer-delphi-horse-exception-logger`
- JWT/Auth → `developer-delphi-horse-jwt` ou `developer-delphi-horse-basic-auth`
