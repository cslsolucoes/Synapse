---
name: developer-delphi-horse-octet-stream
...
# developer-delphi-horse-octet-stream
...
- JSON responses → `developer-delphi-horse-core`
- Compressão → `developer-delphi-horse-compression` (não combinar com streams binários)
