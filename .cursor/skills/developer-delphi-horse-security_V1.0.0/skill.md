---
name: developer-delphi-horse-security
...
- Middleware de validação JWT por rota Horse → `developer-delphi-horse-jwt`
- Middleware de autenticação Basic → `developer-delphi-horse-basic-auth`
- Core do servidor Horse → `developer-delphi-horse-core`
