...
# developer-delphi-language-core_V1.1.0
...
|-------|-----------------|-------------|
| [`developer-delphi-language-types_V1.1.0`](../developer-delphi-language-types_V1.1.0/SKILL.md) | Tipos primitivos, strings, arrays, records, enums, pointers | Declarar tipos de dados, DTOs, flags |
| [`developer-delphi-language-oop_V1.1.0`](../developer-delphi-language-oop_V1.1.0/SKILL.md) | Classes, interfaces, herança, polimorfismo, helpers, operators | Modelar entidades, padrões OOP, ciclo de vida |
| [`developer-delphi-language-generics_V1.1.0`](../developer-delphi-language-generics_V1.1.0/SKILL.md) | TList<T>, TDictionary<K,V>, constraints, patterns genéricos | Coleções type-safe, repository, factory genérica |
| [`developer-delphi-language-rtti_V1.1.0`](../developer-delphi-language-rtti_V1.1.0/SKILL.md) | TRttiContext, attributes, reflection, auto-binding, DI | Mappers, serialização, validação declarativa |
| [`developer-delphi-language-advanced_V1.1.0`](../developer-delphi-language-advanced_V1.1.0/SKILL.md) | Anonymous methods, closures, TProc/TFunc, inline, operators | Callbacks, pipelines funcionais, guard clauses |
...
|-------------|---------------|
| Build/deploy | `developer-delphi-build-cross-compiler` |
| RTL/units/System.* | `developer-delphi-rtl-and-units` |
| Diretivas de engine | `developer-delphi-programming-conditional-defines` |
| Exceptions/diagnóstico | `developer-delphi-error-handling-and-diagnostics` |
| Arquitetura macro | `developer-delphi-architecture-and-design` |
...
- 1.0.0 (2026-04-09): Versão inicial — cross-compiler language rules; migrada de `delphi-fpc-language-core`.
