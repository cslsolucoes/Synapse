...
|----------|---------|-------|
| Como criar objetos sem acoplar ao tipo concreto? | Creational | `developer-delphi-patterns-creational_V1.1.0` |
| Como compor objetos para estruturas maiores? | Structural | `developer-delphi-patterns-structural_V1.1.0` |
| Como distribuir responsabilidade entre objetos? | Behavioral | `developer-delphi-patterns-behavioral_V1.1.0` |
