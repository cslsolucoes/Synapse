...
**Skill:** `developer-delphi-shared-libraries_V1.0.0` → `exemplos/interface_plugin_host.pas`
...
| Daemon Linux + systemd | `developer-delphi-linux-servers_V1.0.0/SKILL.md` |
| DLL exports + memory manager | `developer-delphi-shared-libraries_V1.0.0/SKILL.md` |
| BPL vs DLL análise completa | `developer-delphi-shared-libraries_V1.0.0/consultas_rapidas/bpl_vs_dll_comparison.md` |
| Plugin system via interfaces | `developer-delphi-shared-libraries_V1.0.0/exemplos/interface_plugin_host.pas` |
| Calling conventions Win/Linux | `developer-delphi-shared-libraries_V1.0.0/consultas_rapidas/calling_conventions_win_linux.md` |
