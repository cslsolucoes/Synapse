...
- [ ] **Linux Daemon** — processo de fundo, systemd, SIGTERM handler
  - Skill: `developer-delphi-linux-servers_V1.0.0`
- [ ] **DLL Windows** — biblioteca partilhada, exports explícitos, stdcall
  - Skill: `developer-delphi-shared-libraries_V1.0.0`
- [ ] **SO Linux** — shared object, exports com cdecl, dlopen
  - Skill: `developer-delphi-shared-libraries_V1.0.0` + `developer-delphi-linux-servers_V1.0.0`
- [ ] **BPL (Delphi Package)** — componentes VCL/FMX, partilha de código entre apps Delphi
  - Skill: `developer-delphi-shared-libraries_V1.0.0` (secção BPL)
- [ ] **Multi-plataforma (Win+Linux)** — binários para ambas as plataformas
  - Skill adicional: `developer-delphi-build-cross-compiler_V1.0.0`
...
- [ ] Verificar referência: `developer-delphi-shared-libraries_V1.0.0/consultas_rapidas/dproj_library_multiplatform.md`
...
- [ ] Guia de setup: `developer-delphi-linux-servers_V1.0.0/exemplos/paserver_linux_setup.md`
...
- [ ] Referência: `developer-delphi-shared-libraries_V1.0.0/consultas_rapidas/dproj_library_multiplatform.md`
...
- [ ] Referência: skill `project-diretivas-compilacao_V1.1.0`
...
- [ ] Guia detalhado: `developer-delphi-shared-libraries_V1.0.0/exemplos/dll_memory_manager_guide.md`
- [ ] Armadilhas: `developer-delphi-shared-libraries_V1.0.0/consultas_rapidas/memory_manager_pitfalls.md`
...
- [ ] Referência: `developer-delphi-shared-libraries_V1.0.0/consultas_rapidas/exports_syntax_reference.md`
...
- [ ] Referência: `developer-delphi-shared-libraries_V1.0.0/consultas_rapidas/calling_conventions_win_linux.md`
...
- [ ] Referência: `developer-delphi-linux-servers_V1.0.0/consultas_rapidas/systemd_quick_reference.md`
...
- [ ] Instalar unidade systemd:
  ...
  ```
- [ ] Template: `developer-delphi-linux-servers_V1.0.0/templates/TEMPLATE_daemon.service`
- [ ] Runtime deps: `developer-delphi-linux-servers_V1.0.0/consultas_rapidas/linux_runtime_deps.md`
