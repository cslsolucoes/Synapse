...
description: Testes de integracao em Delphi — banco real com rollback automatico (FireDAC/SQLite), fixtures de dados, smoke tests de modulos e testes de regras de negocio cruzando camadas.
model: sonnet
thinking: extended
...
- Nao usar para performance benchmarks → use `developer-delphi-performance-profiling`.
...
| `developer-delphi-build-cross-compiler` | Build limpo com FireDAC no Search Path |
