...
# developer-delphi-threading-advanced_V1.1.0
...
consulte `developer-delphi-threading-basics_V1.1.0`.
...
- `developer-delphi-threading-basics_V1.1.0` — TThread, TCriticalSection, TMonitor, TEvent
- `developer-delphi-performance-and-memory_V1.0.0` — cache locality, false sharing
