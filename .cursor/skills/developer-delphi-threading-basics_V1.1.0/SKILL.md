...
`developer-delphi-threading-advanced_V1.1.0` para esses tópicos.
...
- `developer-delphi-threading-advanced_V1.1.0` — TTask, TParallel, TThreadedQueue, TInterlocked
- `developer-delphi-performance-and-memory_V1.0.0` — otimização de memória em threads
- `developer-delphi-error-handling-and-diagnostics_V1.0.0` — tratamento de exceções em threads
