...
- Não usar para estratégia multi-skill → use `developer-vuejs-orchestrator`

## Dependências (skills prévias)

| Skill | Quando executar antes |
|-------|----------------------|
| `developer-vuejs-orchestrator` | Se a tarefa envolver múltiplas skills JS, acionar o orquestrador primeiro |
