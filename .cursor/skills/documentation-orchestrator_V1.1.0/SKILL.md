...
- Para versionamento SemVer → `version-orchestrator`
- Para QA e code review → `quality-orchestrator`
- Para implementação técnica de código → `developer-delphi-orchestrator`
