...
- **Obrigatório** neste pack / repositório anfitrião (ex.: Providers.2.1.0): o layout canónico é **subpastas por domínio** + **`Dominio/{ClassName}.md`** com **`ClassName` sem prefixo `T`/`I` no nome do ficheiro. **Não** é opcional “escolher” um layout paralelo.
