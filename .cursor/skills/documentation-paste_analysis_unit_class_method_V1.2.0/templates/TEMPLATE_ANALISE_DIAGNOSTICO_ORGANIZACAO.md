...
|------|-----------------|-------|
| Compilação | `{raiz}/.cursor/skills/project-compile-database-docs_V1.0.1/exemplos/compile.md` | Delphi, FPC, etc. |
| Banco CLI | `{raiz}/.cursor/skills/project-compile-database-docs_V1.0.1/exemplos/database.md` | mysql, sqlite3, … |
| Diretivas | `{raiz}/.cursor/skills/project-diretivas-compilacao_V1.0.1/exemplos/diretivas_compilacao.md` ou equivalente | `USE_*` |
