...
Skills especializadas (opcional): `documentation-constitution-policies` (subsume superseded-definition, migration-conflict-resolution, cursor-rules-integration).
...
- 1.1.5 (02/04/2026): Passo 3 — delegação para **`documentation-sdlc-lifecycle`** (SDLC/runbook/release/segurança/matriz testes).
...
- 1.1.0 (04/04/2026): Renomeada de **`documentation-orchestrator`** para **`documentation-portal-html`** — nome reflecte o foco real (portal HTML estático); pasta **`documentation-portal-html_V1.1.0/`**.
