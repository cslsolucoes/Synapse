...
- Para refatoração com análise de compatibilidade → usar `project-refactoring-compatibility-policy`
...
| `project-refactoring-compatibility-policy` | Ao renomear classes, methods ou units existentes |
