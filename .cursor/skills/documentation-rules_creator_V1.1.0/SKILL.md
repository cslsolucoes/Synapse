...
2. Verificação de faltantes críticos:
   - `.cursor/skills/project-diretivas-compilacao_V1.0.1/exemplos/diretivas_compilacao.md` ou equivalente de diretivas do projeto.
...
- Se `.cursor/skills/project-diretivas-compilacao_V1.0.1/exemplos/diretivas_compilacao.md` não existir ou estiver incompleto, registrar criação/revisão no backlog de execução.
...
## Changelog (este arquivo)
- 1.1.0 (08/04/2026): Migração V2 — adicionadas seções Responsabilidade única, When NOT to use, Dependências, Anti-padrões, Avaliação de risco, Métricas de sucesso, Responsável principal; frontmatter com thinking: normal e category: governance-process.
