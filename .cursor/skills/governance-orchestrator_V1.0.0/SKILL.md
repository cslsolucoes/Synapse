...
- Para documentação técnica canónica → `documentation-orchestrator`
- Para versionamento SemVer e breaking changes → `version-orchestrator`
- Para QA, bugs e code review → `quality-orchestrator`
- Para implementação técnica → `developer-delphi-orchestrator` ou `developer-vuejs-agent-orchestrator`
...
Templates em `.cursor/skills/governance-orchestrator_V1.0.0/templates/`.
