...
```text
[skill ] [cursor   ] developer-delphi-horse-jwt -- Middleware JWT para Horse ...
         .cursor/skills/developer-delphi-horse-jwt_V1.0.0/SKILL.md  (rank=-3.42)
```
...
Saída típica: top-ranked = `developer-delphi-horse-jwt_V1.0.0`. Usar `Read` para carregar o SKILL.md completo só após confirmar relevância via query.
...
# Obter path top-ranked, ex.: .cursor/skills/developer-delphi-providers-pool_V1.0.0/SKILL.md

# Passo 2: abrir via Read tool (IA) ou editor
Read .cursor/skills/developer-delphi-providers-pool_V1.0.0/SKILL.md
```
