...
- Para versionamento ou release → `version-orchestrator`
- Para SDLC formal e release management → `governance-orchestrator`
...
Templates em `.cursor/skills/quality-orchestrator_V1.0.0/templates/`.
