...
- Para escrever testes Delphi/FPC → use `delphi-fpc-testing-and-quality`.
- Para escrever testes Web (Vitest/Jest/Playwright) → use `JS-testing-and-debugging-web`.
