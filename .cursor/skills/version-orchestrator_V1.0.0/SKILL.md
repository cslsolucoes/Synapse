...
- Para gestão de processos de release → `governance-orchestrator` (SDLC)
- Para refatoração segura → `quality-orchestrator`
...
Templates em `.cursor/skills/version-orchestrator_V1.0.0/templates/`.
